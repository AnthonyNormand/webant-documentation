...
return [
    ...
    'timestamp' => 1499275266,
    'checksum' => '5a8871f309b20f364a9b43589ba13a5a',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/hightlight' => [
                'file' => 'user/plugins/hightlight/blueprints.yaml',
                'modified' => 1496074651
            ],
            'plugins/admin' => [
            ...
            'plugins/prism' => [
                'file' => 'user/plugins/prism/blueprints.yaml',
                'modified' => 1497707902
            ],
            'plugins/feed' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.hightlight.enabled' => [
                ...
                'name' => 'plugins.hightlight.enabled',
                'validation' => 'strict'
            ],
            'plugins.hightlight.theme' => [
                'type' => 'select',
                'label' => 'CSS Theme',
                'default' => 'default',
                'options' => [
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'hightlight' => [
                    'enabled' => 'plugins.hightlight.enabled',
                    'theme' => 'plugins.hightlight.theme'
                ],
                'admin' => [
                ...
                'prism' => [
                    'enabled' => 'plugins.prism.enabled',
                    'theme' => 'plugins.prism.theme'
                ],
                'feed' => [
